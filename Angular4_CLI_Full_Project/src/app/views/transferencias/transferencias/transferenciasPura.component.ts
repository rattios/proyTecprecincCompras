  ...
  constructor(private http: HttpClient, private ruta: RutaService) {
   ...
   ngOnInit(): void {
     ...
     console.log(principio);
      ...
      this.http.get(this.ruta.get_ruta()+'transferencias/index/pura?inicio='+datePipe.transform(principio, 'dd-MM-yyyy')+'&fin='+datePipe.transform(new Date(), 'dd-MM-yyyy'))
           .toPromise()
           .then(
           data => {
             console.log(data);
    ...
    buscar(){
      ...
      var datePipe = new DatePipe("en-US");
      this.http.get(this.ruta.get_ruta()+'transferencias/index/pura?inicio='+datePipe.transform(this.inicioD2, 'dd-MM-yyyy')+'&fin='+datePipe.transform(this.finD2, 'dd-MM-yyyy'))
           .toPromise()
           .then(
           data => {
             console.log(data);
