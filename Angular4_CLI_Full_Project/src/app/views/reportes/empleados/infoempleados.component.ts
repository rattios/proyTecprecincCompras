...
@Component({
  selector: 'app-infoempleados',
  templateUrl: 'infoempleados.component.html'
})
export class infoempleadosComponent {
  public prov: any;
  public pedidos: any;
  ...
  constructor(private http: HttpClient, private ruta: RutaService, private parent: empleadosComponent) {
